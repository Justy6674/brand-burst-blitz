      ...
      <section id="pricing" className="py-20 bg-gradient-to-b from-background to-muted/20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Choose Your <span className="text-gradient-primary">Business Growth Plan</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Australian pricing with no hidden fees. Start with early adopter discounts and opt out anytime.
            </p>
            <div className="bg-gradient-to-r from-success/10 to-primary/10 rounded-xl p-4 border border-success/20 max-w-2xl mx-auto">
              <p className="text-success font-semibold">🎉 Early Adopter Special: Save 30% for the first 3 months</p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 mb-16">
            ...
            <Card className="p-8 hover-lift bg-gradient-to-br from-muted/25 to-muted/5 border-2 border-muted/40 shadow-xl relative">
              <CardContent className="p-0">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-foreground">Solo Business</h3>
                  <p className="text-muted-foreground mb-4">Perfect for single practice owners</p>
                  <div className="mb-4">
                    <span className="text-4xl font-bold text-gradient-primary">$49</span>
                    <span className="text-lg text-muted-foreground ml-2">AUD/month</span>
                  </div>
                  <Badge className="bg-muted/20 text-muted-foreground">No Setup Required</Badge>
                </div>
                
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">1 Business Profile</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Up to 3 Social Channels</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">200 AI-generated posts/month</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">1 Blog Seat</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Calendar & Basic Analytics</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Website/Blog Sync</span>
                  </li>
                </ul>
            ...
            <Card className="p-8 hover-lift bg-gradient-to-br from-primary/10 to-secondary/10 border-2 border-primary/40 shadow-2xl relative transform scale-105">
              ...
              <CardContent className="p-0">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-foreground">Growth (×3 Biz)</h3>
                  <p className="text-muted-foreground mb-4">For growing multi-practice businesses</p>
                  <div className="mb-4">
                    <span className="text-4xl font-bold text-gradient-primary">$119</span>
                    <span className="text-lg text-muted-foreground ml-2">AUD/month</span>
                  </div>
                  <Badge className="bg-primary/20 text-primary">Best Value</Badge>
                </div>
                
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm font-medium">Up to 3 Business Profiles</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Up to 10 Social Channels</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">1,000 AI posts/month</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">3 Blog Seats</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Ad Builder (2 campaigns/month)</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Compliance Flags & Standard Support</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Cross-Business Analytics</span>
                  </li>
                </ul>
            ...
            {/* Unlimited Agency */}
            <Card className="p-8 hover-lift bg-gradient-to-br from-accent/10 to-muted/5 border-2 border-accent/40 shadow-xl relative">
              <CardContent className="p-0">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-foreground">Unlimited (Agency)</h3>
                  <p className="text-muted-foreground mb-4">For agencies and large organizations</p>
                  <div className="mb-4">
                    <span className="text-4xl font-bold text-gradient-primary">$249</span>
                    <span className="text-lg text-muted-foreground ml-2">AUD/month</span>
                  </div>
                  <Badge className="bg-accent/20 text-accent">Enterprise Grade</Badge>
                </div>
                
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm font-medium">Unlimited Business Profiles</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Unlimited Social Channels</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">5,000 AI posts/month</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">Unlimited Blog Seats</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                  ...
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
                    <span className="text-sm">SLA Support & Team Roles</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-4 h-4 text-success mr-3 flex-shrink-0" />
          ...
          {/* Setup Services Add-On */}
          <div className="bg-gradient-to-r from-muted/20 to-muted/10 rounded-2xl p-8 border border-muted/30 mb-12">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4 text-foreground">Optional Remote Setup Assistance</h3>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Get expert help with platform configuration and integration. Perfect for busy practices and agencies.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
              {/* Standard Setup */}
              <Card className="p-6 bg-gradient-to-br from-background to-muted/10 border-2 border-muted/40">
                <CardContent className="p-0">
                  <div className="text-center mb-4">
                    <h4 className="text-xl font-bold mb-2 text-foreground">Standard Setup</h4>
                    <div className="mb-4">
                      <span className="text-3xl font-bold text-gradient-primary">$299</span>
                      <span className="text-sm text-muted-foreground ml-2">AUD (2 hours)</span>
                    </div>
                  </div>
                  
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
                      <span>Meta Business Suite + Page/App connection</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
                      <span>Blog-CMS sync configuration</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
                      <span>Basic AI prompt tuning</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
                      <span>1-month health-check setup</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 bg-gradient-to-br from-primary/5 to-secondary/5 border-2 border-primary/30">
                <CardContent className="p-0">
                  <div className="text-center mb-4">
                    <h4 className="text-xl font-bold mb-2 text-foreground">Premium Setup</h4>
                    <div className="mb-4">
                      <span className="text-3xl font-bold text-gradient-primary">$699</span>
                      <span className="text-sm text-muted-foreground ml-2">AUD (5 hours)</span>
                    </div>
                  </div>
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
                      <span>Custom AI-prompt library creation</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
                      <span>Template design & optimization</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
                      <span>Team-role configuration</span>
                    </li>
                    <li className="flex items-center">
                      <Check className="w-3 h-3 text-success mr-2 flex-shrink-0" />
          ...
          <div className="text-center bg-gradient-to-r from-success/5 via-primary/5 to-secondary/5 rounded-2xl p-8 border border-primary/20">
            <h3 className="text-2xl font-bold mb-4 text-foreground">Honest, Flexible Terms</h3>
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-success/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Check className="w-8 h-8 text-success" />
                </div>
                <h4 className="font-semibold text-success mb-2">No Lock-in Contracts</h4>
                <p className="text-sm text-muted-foreground">Opt out anytime, no questions asked</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <DollarSign className="w-8 h-8 text-primary" />
                </div>
                <h4 className="font-semibold text-primary mb-2">Early Adopter Savings</h4>
                <p className="text-sm text-muted-foreground">30% off for first 100 customers</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Shield className="w-8 h-8 text-secondary" />
                </div>
                <h4 className="font-semibold text-secondary mb-2">Australian Owned</h4>
                <p className="text-sm text-muted-foreground">Local support, local pricing</p>
              </div>
            </div>
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto">
              <strong className="text-foreground">Replace $10,000+ in monthly agency fees</strong> with one comprehensive platform. 
              All plans include enterprise security, OpenAI/Gemini integration, and everything you need to dominate your market.
            </p>
          </div>
        </div>
      </section>
