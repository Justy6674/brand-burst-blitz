...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Core Setup Services - Brief */}
      <section className="relative py-16 md:py-20 overflow-hidden mx-2 md:mx-4 lg:mx-8 my-4 md:my-8 rounded-xl md:rounded-2xl border border-gray-300/20 bg-black/5 backdrop-blur-sm">
        <div className="absolute inset-0 z-0 rounded-xl md:rounded-2xl overflow-hidden">
          <img 
            src="https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" 
        ...
        <div className="relative z-20 container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Expert Australian business setup services to get you operational fast.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card className="border-2 border-orange-500/30 bg-gradient-to-br from-orange-500/10 to-orange-600/10">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">Australian Social Setup</CardTitle>
                  <Badge className="bg-orange-500 text-white px-3 py-1">$199-299</Badge>
                </div>
                <CardDescription>Complete social media setup with Australian compliance</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Facebook Business Manager setup</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Instagram Business optimization</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">LinkedIn Business configuration</span>
                  </li>
                </ul>
                <ComingSoonPopup trigger={
            ...
            <Card className="border-2 border-orange-500/30 bg-gradient-to-br from-orange-500/10 to-orange-600/10">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">Name & Domain Scout</CardTitle>
                  <Badge className="bg-orange-500 text-white px-3 py-1">$69-99</Badge>
                </div>
                <CardDescription>Professional business name research with ASIC checks</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">ASIC business name availability</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Domain availability analysis</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-orange-500 mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Professional research report</span>
                  </li>
                </ul>
                <ComingSoonPopup trigger={
                  <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">
          ...
          <div className="text-center mt-8">
            <Link to="/all-services" className="text-orange-400 hover:text-orange-300 font-medium">
