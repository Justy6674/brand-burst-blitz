...
import { Calendar, Clock, ArrowRight, Search, Filter, Star, Eye } from 'lucide-react';
...
const BlogPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-20 container mx-auto px-4 md:px-6">
          <div className="max-w-5xl mx-auto animate-fade-in text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-6 md:mb-8 leading-tight text-white">
              <span className="text-yellow-400">LIVE PLATFORM</span><br />
              <span className="text-white">DEMONSTRATION</span>
            </h1>
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/90 mb-8 md:mb-12 leading-relaxed max-w-4xl mx-auto px-2">
              🚀 This entire blog is <span className="text-yellow-400 font-bold">generated by our platform</span> - proving our system works! Every post created through our members area, automatically TGA/AHPRA-compliant.
            </p>
      ...
      <section className="py-6 bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 animate-pulse">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-white font-bold text-lg md:text-xl">
              💼 THIS IS OUR BUSINESS CARD - Every post below created with our healthcare platform 🏥
            </p>
