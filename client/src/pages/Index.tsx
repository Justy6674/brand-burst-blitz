        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              This Website Is Our Business Card
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Every page you're browsing was built using our healthcare marketing platform. 
              The blog, SEO optimization, content quality - it's all generated by the system you can own.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Professional Healthcare Website</h4>
                      <p className="text-gray-600 text-sm">Built in 5 minutes using our platform's templates</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">AHPRA-Compliant Blog Content</h4>
                      <p className="text-gray-600 text-sm">AI-generated healthcare content that meets Australian standards</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Google SEO Optimization</h4>
                      <p className="text-gray-600 text-sm">Automatic sitemap, meta tags, and search engine visibility</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Mobile-Responsive Design</h4>
                      <p className="text-gray-600 text-sm">Perfect patient experience on any device</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl p-8 text-white text-center">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold mb-2">The Ultimate Proof</h3>
                  <p className="text-blue-100">
                    We don't just sell healthcare websites - we USE our platform for our own business. 
                    That's confidence in our product.
                  </p>
                </div>
                
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 mb-6">
                  <p className="text-sm font-medium">
                    "If it's good enough for us to build our business on, 
                    it's good enough for your healthcare practice."
                  </p>
                </div>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-2 bg-green-100 text-green-700 px-4 py-2 rounded-full">
              ...
              <span className="text-sm font-medium">Live Platform Demo - Browse and See It In Action</span>
            </div>
          </div>
        </div>
      </section>
